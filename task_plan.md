...
- Interface tuning should improve the public shape rather than reduce capability or method count. Adding interfaces or methods is acceptable when it clarifies inheritance, separates real capabilities, or improves reuse. The goal is to organize method groups, fix naming details, clarify inheritance, and make implementations reuse shared algorithm cores instead of duplicating algorithm bodies in every container.
