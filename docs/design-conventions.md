...
这类 helper；`platform.sync` 只继续保留 nextPas 的 public opaque storage contract、public
result adapter、wait-bucket 策略与跨平台 wake/wait public contract。对应地，`platform.sync`
