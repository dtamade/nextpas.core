...
function android_errno_value: Int32; inline;
function android_pthread_sync_result(
  const AError: Int32;
...
function android_fstat_fd(
  const AFileDescriptor: TPlatformFileDescriptor;
  out ABuffer: TPlatformAndroidStat): Int32; inline;
function android_thread_self_token_u64: UInt64; inline;
function android_native_thread_id_u64: UInt64; inline;
function android_cpu_count_i32: Int32; inline;
function android_pthread_create_handle(AThreadStorage: Pointer; const AStartRoutine: Pointer; const AArgument: Pointer): Int32; inline;
function android_pthread_join_handle(AThreadStorage: Pointer; ARetVal: Pointer): Int32; inline;
function android_pthread_detach_handle(AThreadStorage: Pointer): Int32; inline;
function android_pthread_state_create(out AState: PPlatformPThreadState; const AStartRoutine: Pointer; const AArgument: Pointer): Int32; inline;
function android_pthread_state_join(const AState: PPlatformPThreadState; out ARetVal: Pointer): Int32; inline;
function android_pthread_state_detach(const AState: PPlatformPThreadState): Int32; inline;
procedure android_pthread_yield; inline;
procedure android_pthread_sleep_ns(const ANanoseconds: UInt64); inline;
function android_pthread_tls_create(out AKey: PtrUInt): Int32; inline;
function android_pthread_tls_destroy(const AKey: PtrUInt): Int32; inline;
function android_pthread_tls_set(const AKey: PtrUInt; const AValue: Pointer): Int32; inline;
function android_pthread_tls_get(const AKey: PtrUInt): Pointer; inline;
function android_clock_monotonic_now(ATime: Pointer): Int32; inline;
function android_clock_realtime_now(ATime: Pointer): Int32; inline;
function android_clock_monotonic_getres(ATime: Pointer): Int32; inline;
function android_clock_monotonic_ns_u64: UInt64; inline;
function android_clock_realtime_ns_u64: UInt64; inline;
function android_clock_monotonic_resolution_ns_u64: UInt64; inline;
function android_pthread_timeout_clock_now(ATime: Pointer): Int32; inline;
function android_pthread_timeout_deadline_after_ns(
  const ANanoseconds: UInt64;
  out ADeadline: timespec): Int32; inline;
function android_pthread_timeout_remaining_ns_u64(
  const ADeadline: PTimeSpec;
  out ARemainingNs: UInt64): Int32; inline;
function android_pthread_mutex_init_platform_kind(AMutex: Pointer; const AKind: Int32): Int32; inline;
function android_pthread_mutex_init(AMutex: Pointer; const AKind: Int32): Int32; inline;
function android_pthread_mutex_destroy(AMutex: Pointer): Int32; inline;
function android_pthread_mutex_lock(AMutex: Pointer): Int32; inline;
function android_pthread_mutex_trylock(AMutex: Pointer): Int32; inline;
function android_pthread_mutex_timedlock_abs(AMutex: Pointer; ADeadline: Pointer): Int32; inline;
function android_pthread_mutex_unlock(AMutex: Pointer): Int32; inline;
function android_pthread_rwlock_init(ARwLock: Pointer): Int32; inline;
function android_pthread_rwlock_destroy(ARwLock: Pointer): Int32; inline;
function android_pthread_rwlock_rdlock(ARwLock: Pointer): Int32; inline;
function android_pthread_rwlock_tryrdlock(ARwLock: Pointer): Int32; inline;
function android_pthread_rwlock_wrlock(ARwLock: Pointer): Int32; inline;
function android_pthread_rwlock_trywrlock(ARwLock: Pointer): Int32; inline;
function android_pthread_rwlock_rdunlock(ARwLock: Pointer): Int32; inline;
function android_pthread_rwlock_wrunlock(ARwLock: Pointer): Int32; inline;
function android_pthread_condvar_init(ACondVar: Pointer): Int32; inline;
function android_pthread_condvar_destroy(ACondVar: Pointer): Int32; inline;
function android_pthread_condvar_wait(ACondVar: Pointer; AMutex: Pointer): Int32; inline;
function android_pthread_condvar_timedwait_abs(ACondVar: Pointer; AMutex: Pointer; ADeadline: Pointer): Int32; inline;
function android_pthread_condvar_signal(ACondVar: Pointer): Int32; inline;
function android_pthread_condvar_broadcast(ACondVar: Pointer): Int32; inline;
...
function android_errno_value: Int32; inline;
begin
  Result := platform_posix_errno_value_from_location(android_errno_location);
end;
...
procedure android_pthread_sleep_ns(const ANanoseconds: UInt64); inline;
begin
  platform_posix_pthread_sleep_ns(ANanoseconds, android_errno_location, PLATFORM_POSIX_EINTR);
end;
...
begin
  Result := platform_posix_pthread_condvar_init_with_clock(
    ...
    @android_pthread_condattr_setclock);
end;
